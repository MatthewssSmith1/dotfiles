#!/usr/bin/env bash
# Git area behavior deployed through bootstrap: host/profile detection, closure
# layering, identity and guarded global-config handling, legacy migration,
# locking, state validation, and rollback.
...
printf 'PASS: %s Git deployment test groups\n' "$TEST_COUNT"
