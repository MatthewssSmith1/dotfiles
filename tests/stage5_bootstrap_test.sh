...
sed -i 's/^area|bash|ready$/area|bash|framework/; s/^area|tmux|ready$/area|tmux|framework/; s/^area|nvim|ready$/area|nvim|framework/; s/^area|zsh|ready$/area|zsh|framework/; s/^area|herdr|ready$/area|herdr|framework/' \
