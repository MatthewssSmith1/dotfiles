...
The tmux keybinding unbinds in [docs/environments/windows-terminal.md](../docs/environments/windows-terminal.md) remain manual and are the next candidate for the managed surface.
